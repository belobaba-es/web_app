...
type InternalBeneficiaryCryptoStore = {
...
export const useInternalBeneficiaryListCryptoStore = defineStore('useInternalBeneficiaryListCryptoStore', {
  state: (): InternalBeneficiaryCryptoStore => ({
    beneficiary: [],
