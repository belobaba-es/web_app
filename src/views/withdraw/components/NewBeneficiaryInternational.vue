...
<template>
  <div class="w-75">
    ...
    <div class="col-12 md:col-8">
      ...
      <div class="field">
        <label v-show="form.intermediaryBank.intermediaryNumberType == 'ROUTING_NUMBER'">{{ t(' Intermediary Routing Number') }} </label>
        <label v-show="form.intermediaryBank.intermediaryNumberType == 'SWIFT_CODE'">{{ t(' Intermediary Swift Code') }} </label>
        <div class="p-inputgroup">
...
const saveBeneficiary = () => {
  ...
  beneficiaryService.saveBeneficiaryInternational(form.value).then(resp => {
