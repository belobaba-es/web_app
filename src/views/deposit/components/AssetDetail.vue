<template>
    <div class="flex justify-content-between align-items-center asset-item" >
        <div class="flex align-items-center">
            <div class="asset-icon">
                <img :src=" asssetImg(paymentAddress.assetsId)">
            </div>
            <span class="font-semi-bold">{{assetName(paymentAddress.assetsId)}}</span>
        </div>
        <span>{{paymentAddress.label}}</span>
