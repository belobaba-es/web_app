      ...
      <div class="col-12 sm:col-12 md:col-12 lg:col-6 xl:col-6">
        ...
        <div class="flex-row">
          ...
          <div class="text-center mt-3 mb-3" v-if="quoteId">
            ...
            /
            <span class="font-medium text-primary text-2xl">Total:</span> <span
              class="text-2xl font-medium">{{ totalAmount }}</span>
          </div>
          <div class="mb-2">
...
const {
  ...
  loading, quoteId, feeAmount, totalAmount, transactionType, assetCode, shouldRefreshQuote
