        ...
        <div class="grid flex justify-content-center align-items-center">
            <div class="col-6">
                ...
                <div class="my-5 flex justify-content-between">
                    <div>
                        ...
                        <div class="flex" v-else>
                            <div class="flex-shrink-0 flex align-items-center mr-2">
                                <img alt="logo" :src="transactionSummary.assetIcon" style="width: 4rem" />
                            </div>
                            <div class="flex-grow-1 flex-row align-items-center">
                ...
                <div class="text-center" v-if="transactionSummary.quoteId">
                    <span class="font-medium text-primary text-2xl">Fee:</span> <span class="text-2xl font-medium">{{ transactionSummary.feeAmount }}</span> 
                    / 
                    <span class="font-medium text-primary text-2xl">Total:</span> <span class="text-2xl font-medium">{{ transactionSummary.totalAmount }}</span>
                </div>
